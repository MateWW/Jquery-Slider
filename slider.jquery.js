(function($,document,window,undefined){
	...
	$.fn.MWslider.moveSlider = function(that,site,config){
		...
		elements={
			left:that.elements.eq(pos[0]),
			right:that.elements.eq(pos[2]),
			center:that.elements.eq(pos[1])
		}		
		
		that.elements.removeClass();

		elements.right.addClass("right");				
		elements.center.addClass("center");
		elements.left.addClass("left");
